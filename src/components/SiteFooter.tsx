      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '0.6rem', marginBottom: '1.75rem' }}>
              {[
                ...
                { label: 'YouTube', d: 'M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46a2.78 2.78 0 0 0-1.95 1.96A29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58A2.78 2.78 0 0 0 3.41 19.54C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.95-1.96A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z' },
          ...
          <div>
            ...
            {[['/', 'Home'], ['/watch', 'Watch TV'], ['/listen', 'Audio Teachings'], ['/read', 'Daily Devotional'], ['/healing', 'Healing Center'], ['/give', 'Partner With Us'], ['/espanol', 'En Español']].map(([href, label]) => (
          ...
          <div>
            ...
            {[['teachings', 'Browse Teachings'], ['blog', 'Blog & Articles'], ['commentary', 'Living Commentary'], ['events', 'Events Calendar'], ['schedule', 'Broadcast Schedule'], ['store', 'Resource Store'], ['account', 'My Account']].map(([slug, label]) => (
              <Link key={slug} href={`/${slug}`} className="footer-link">{label}</Link>
            ))}
          </div>
