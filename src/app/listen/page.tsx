...
const AUDIOS: (Track & { category: string; description: string; year: string })[] = [
  { id: 'aud1', title: 'Spirit, Soul & Body: Part 1', speaker: 'Andrew Wommack', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', coverUrl: '/images/hero_background.png', duration: '42:18', category: 'Spirit, Soul & Body', description: 'Understand the relational structure of your spirit, soul, and body. Learn how your spirit was instantly perfected at salvation.', year: '2025' },
  { id: 'aud2', title: 'Spirit, Soul & Body: Part 2', speaker: 'Andrew Wommack', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', coverUrl: '/images/hero_background.png', duration: '45:30', category: 'Spirit, Soul & Body', description: 'Why your physical senses compete with your born-again spirit — and how the Word of God serves as a spiritual mirror.', year: '2025' },
  { id: 'aud3', title: "The Believer's Authority: Part 1", speaker: 'Andrew Wommack', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', coverUrl: '/images/truth_liberty.png', duration: '38:10', category: "Believer's Authority", description: 'Explore the authority God has delegated to you as a believer. Stop begging God to do what He already commanded you to do.', year: '2026' },
  { id: 'aud4', title: "The Believer's Authority: Part 2", speaker: 'Andrew Wommack', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', coverUrl: '/images/truth_liberty.png', duration: '40:15', category: "Believer's Authority", description: 'How to stand against satanic operations and enforce the victory Jesus already won.', year: '2026' },
  { id: 'aud5', title: "You've Already Got It!: Part 1", speaker: 'Andrew Wommack', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3', coverUrl: '/images/charis_college.png', duration: '44:50', category: "You've Already Got It", description: 'God has already blessed you with all spiritual blessings in Christ. Your healing and provision are waiting to manifest.', year: '2024' },
  { id: 'aud6', title: "You've Already Got It!: Part 2", speaker: 'Andrew Wommack', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3', coverUrl: '/images/charis_college.png', duration: '43:10', category: "You've Already Got It", description: "How to bypass unbelief and open the channel of faith so God's power flows from your spirit into your circumstances.", year: '2024' },
  { id: 'aud7', title: 'A Better Way to Pray: Part 1', speaker: 'Andrew Wommack', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3', coverUrl: '/images/hero_background.png', duration: '37:40', category: 'Prayer & Communion', description: 'Andrew challenges conventional prayer. Prayer is not about twisting God\'s arm — it\'s about communion and releasing His grace.', year: '2025' },
  { id: 'aud8', title: 'A Better Way to Pray: Part 2', speaker: 'Andrew Wommack', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3', coverUrl: '/images/hero_background.png', duration: '39:55', category: 'Prayer & Communion', description: "Commanding prayer vs pleading prayer. Harness the power of faith and declare God's promises over your health.", year: '2025' },
];
      ...
      <div style={{ background: 'linear-gradient(135deg, hsl(var(--brand-blue-dark)), #020617)', padding: '4rem 0 5rem', color: 'white', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.62)', maxWidth: '540px', fontSize: '0.97rem', lineHeight: 1.65 }}>
            Stream hundreds of Andrew Wommack's core teaching series — absolutely free. The audio player persists as you browse.
          </p>
        </div>
      </div>
