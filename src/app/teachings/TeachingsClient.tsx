...
const SERIES = [
  { id: 1, title: 'Spirit, Soul & Body', parts: 4, topic: 'Identity', type: 'audio', cover: '/images/1000045321.webp', description: 'Understand how your born-again spirit is the real you and how to align your soul with the life of God already in you.', popular: true },
  { id: 2, title: "The Believer's Authority", parts: 4, topic: 'Authority', type: 'audio', cover: '/images/1000045328.webp', description: 'Stop begging God to do what He has already commanded you to do. Learn to command your healing and victory.', popular: true },
  { id: 3, title: "You've Already Got It!", parts: 4, topic: 'Faith', type: 'audio', cover: '/images/1000045329.webp', description: 'God has already provided everything you need. Discover how to receive by faith what grace has already provided.', popular: false },
  { id: 4, title: "God's Will is Healing", parts: 6, topic: 'Healing', type: 'video', cover: '/images/1000045321.webp', description: 'A comprehensive study proving from scripture that healing is always the will of God for every believer.', popular: true },
  { id: 5, title: 'A Better Way to Pray', parts: 4, topic: 'Prayer', type: 'audio', cover: '/images/1000045327.webp', description: "Discover that prayer is not about twisting God's arm — it's about communion and releasing His already-given grace.", popular: false },
  { id: 6, title: 'Grace — The Power of the Gospel', parts: 8, topic: 'Grace', type: 'video', cover: '/images/1000045328.webp', description: 'The most thorough teaching on grace available. Understand what grace really is and how it changes everything.', popular: true },
  { id: 7, title: 'The New You & the Holy Spirit', parts: 6, topic: 'Holy Spirit', type: 'video', cover: '/images/1000045329.webp', description: 'A deep dive into who the Holy Spirit is and how to partner with Him in your daily life and ministry.', popular: false },
  { id: 8, title: 'Financial Stewardship', parts: 3, topic: 'Finances', type: 'audio', cover: '/images/1000045321.webp', description: 'Biblical principles for financial prosperity. God wants you to prosper — learn how to walk in it.', popular: false },
  { id: 9, title: 'Effortless Change', parts: 5, topic: 'Grace', type: 'audio', cover: '/images/1000045327.webp', description: "Sanctification is not about trying harder. It's about renewing your mind to who God already made you to be.", popular: false },
  { id: 10, title: 'Harnessing Your Emotions', parts: 4, topic: 'Identity', type: 'audio', cover: '/images/1000045328.webp', description: 'Your emotions are real but not truth. Learn to align them with what God says about you.', popular: false },
  { id: 11, title: 'Relationship Principles', parts: 6, topic: 'Relationships', type: 'video', cover: '/images/1000045329.webp', description: "God's design for relationships — marriage, family, and friendship rooted in unconditional love.", popular: false },
  { id: 12, title: 'Salvation — What Does It Include?', parts: 3, topic: 'Salvation', type: 'audio', cover: '/images/1000045321.webp', description: 'Salvation is more than going to heaven. Discover the full scope of what Jesus purchased for you at the cross.', popular: false },
];
